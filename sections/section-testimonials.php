<div class="testimonial pure-g">
  <div class="pure-u-1">
    <h1 class="header"><span class="bold-head">What our Happy</span> customers say</h1>
    <img class="customer-img" src="<?php echo get_template_directory_uri() . '/assets/images/customer-img.png'; ?>" alt="">
